...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    description='The stock_move_extra_products_supply module allows to add '
    'several extra products in a shipment/production/bom line from which '
    'purchase request of these products will be generated',
